...
namespace Marka_WebUI.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        private Payment PaymentProcess(OrderModel model)
        {
            ...
            shippingAddress.ContactName = "Enes Şimşek";
            shippingAddress.City = "Ankara";
            shippingAddress.Country = "Turkey";
            shippingAddress.Description = "Yenimahalle";
            shippingAddress.ZipCode = "38381";
            request.ShippingAddress = shippingAddress;

            Address billingAddress = new Address();
            billingAddress.ContactName = "Enes Şimşek";
            billingAddress.City = "Ankara";
            billingAddress.Country = "Turkey";
            billingAddress.Description = "Yenimahalle";
            billingAddress.ZipCode = "38381";
